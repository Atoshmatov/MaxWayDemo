...
public final class DaggerApp_HiltComponents_SingletonC extends App_HiltComponents.SingletonC {
  ...
  public static final class Builder {
    ...
    public Builder homeFirebaseModule(HomeFirebaseModule homeFirebaseModule) {
      Preconditions.checkNotNull(homeFirebaseModule);
      return this;
    }
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return ImmutableSet.<String>of(SplashScreenViewModelImpl_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      this.splashScreenViewModelImplProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, Provider<ViewModel>>of("uz.gita.maxwaydemo.mobdev.presentation.viewModel.splash.impl.SplashScreenViewModelImpl", ((Provider) splashScreenViewModelImplProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // uz.gita.maxwaydemo.mobdev.presentation.viewModel.splash.impl.SplashScreenViewModelImpl 
